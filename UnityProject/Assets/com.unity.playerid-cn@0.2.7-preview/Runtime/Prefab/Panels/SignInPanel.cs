...
namespace UnityEngine.PlayerIdentity.UI
{
    public class SignInPanel : AbstractPanel
    {
        ...
        void Start()
        {
            ...
            anonymousLogin.gameObject.SetActive(false);
            phoneLogin.gameObject.SetActive(false);
        }
        ...
        private void OnExternalLoginClicked(string providerId)
        {
            ...
            catch (Exception e)
            {
                ...
                mainController.PopupController.ShowError(new Error { message = "连接provider时发生错误" });
            }
        }
